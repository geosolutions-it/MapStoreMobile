 ...
 */
package it.geosolutions.android.map.geostore.adapters;
 ...
 */
public class GeoStoreResourceAdapter extends
        ArrayAdapter<Resource> {

int resourceId = R.layout.geostore_resource_row;
 ...
 * @param resource
 */
public GeoStoreResourceAdapter(Context context, int resource) {
 ...
 * @param layers
 */
public GeoStoreResourceAdapter(SherlockFragmentActivity context, int resource,
        ArrayList<Resource> layers) {
...
public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (result != null) {
        ...
        // TODO use ViewHolder
        // display name
        TextView name = (TextView) v.findViewById(R.id.geostore_resource_name);
        if (name != null) {
