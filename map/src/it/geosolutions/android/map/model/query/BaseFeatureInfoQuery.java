...
public class BaseFeatureInfoQuery implements Parcelable{
	 ...
	 * @param source
	 */
	public BaseFeatureInfoQuery(Parcel source){
		zoomLevel=source.readByte();
		srid=source.readString();
	}
	
	public BaseFeatureInfoQuery(BaseFeatureInfoQuery b){
	...
	public BaseFeatureInfoQuery(){}
	 ...
	 public static final Parcelable.Creator<BaseFeatureInfoQuery> CREATOR
     = new Parcelable.Creator<BaseFeatureInfoQuery>() {
	 public BaseFeatureInfoQuery createFromParcel(Parcel in) {
	     return new BaseFeatureInfoQuery(in);
	 }

	 public BaseFeatureInfoQuery[] newArray(int size) {
	     return new BaseFeatureInfoQuery[size];
	 }
	};
